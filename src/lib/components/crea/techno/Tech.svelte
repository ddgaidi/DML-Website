...
<div class="transition-all duration-500 flex flex-col items-center justify-center pt-[50px] bg-[#f4f3fc] dark:bg-[#0C0C12]" id="techno-container">
  ...
  <div class="flex flex-row" id="row">
    ...
    <a class="flex m-5 flex-col items-center no-underline" href="https://developer.mozilla.org/fr/docs/Web/JavaScript" target="_blank">
      <div class="relative transition-all duration-300 group flex flex-col justify-center items-center bg-[#d4d5e2] dark:bg-[#14141E] w-[100px] h-[100px] rounded-[10px] hover:bg-[#c7c9d8] dark:hover:bg-[#191925] hover:scale-110 hover:cursor-pointer" id="css-container">
        <img src={jsd} alt="HTML Noir" class="absolute top-[14px] transition-opacity duration-500 ease-in-out h-[40px] {$darkMode ? 'opacity-100' : 'opacity-0'}" />
        <img src={jsw} alt="HTML Blanc" class="absolute top-[12px] transition-opacity duration-500 ease-in-out h-[43px] {$darkMode ? 'opacity-0' : 'opacity-100'}" />
        <p class="mt-[45px] transition-all duration-300 text-l text-[#5e5e5e] group-hover:text-black dark:text-[#a2a4b3] dark:group-hover:text-white no-underline font-family: 'Outfit', sans-serif">JavaScript</p>
      </div>
    </a>

    <a class="flex m-5 flex-col items-center no-underline" href="https://www.typescriptlang.org/" target="_blank">
      <div class="relative transition-all duration-300 group flex flex-col justify-center items-center bg-[#d4d5e2] dark:bg-[#14141E] w-[100px] h-[100px] rounded-[10px] hover:bg-[#c7c9d8] dark:hover:bg-[#191925] hover:scale-110 hover:cursor-pointer" id="css-container">
        <img src={tsd} alt="HTML Noir" class="absolute top-[14px] transition-opacity duration-500 ease-in-out h-[40px] {$darkMode ? 'opacity-100' : 'opacity-0'}" />
        <img src={tsw} alt="HTML Blanc" class="absolute top-[12px] transition-opacity duration-500 ease-in-out h-[43px] {$darkMode ? 'opacity-0' : 'opacity-100'}" />
        <p class="mt-[45px] transition-all duration-300 text-l text-[#5e5e5e] group-hover:text-black dark:text-[#a2a4b3] dark:group-hover:text-white no-underline font-family: 'Outfit', sans-serif">TypeScript</p>
      </div>
    </a>
  ...
  <div class="flex flex-row" id="row">    
    ...
    <a class="flex m-5 flex-col items-center no-underline" href="https://learn.microsoft.com/fr-fr/cpp/c-language/?view=msvc-170" target="_blank">
      <div class="relative transition-all duration-300 group flex flex-col justify-center items-center bg-[#d4d5e2] dark:bg-[#14141E] w-[100px] h-[100px] rounded-[10px] hover:bg-[#c7c9d8] dark:hover:bg-[#191925] hover:scale-110 hover:cursor-pointer" id="python-container">
        <img src={cd} alt="HTML Noir" class="absolute top-[14px] transition-opacity duration-500 ease-in-out h-[40px] {$darkMode ? 'opacity-100' : 'opacity-0'}" />
        <img src={cw} alt="HTML Blanc" class="absolute top-[12px] transition-opacity duration-500 ease-in-out h-[43px] {$darkMode ? 'opacity-0' : 'opacity-100'}" />
        <p class="mt-[45px] transition-all duration-300 text-l text-[#5e5e5e] group-hover:text-black dark:text-[#a2a4b3] dark:group-hover:text-white no-underline font-family: 'Outfit', sans-serif">C</p>
      </div>
    </a>
